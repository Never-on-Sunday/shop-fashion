...
public class ManageProductsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			request.setAttribute("nextProductID", productBO.getTheNextProductID());

			RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/manageProduct.jsp");
